...
from slop.structural.ccx import FileMetrics, ccx_kernel
from slop.structural.ccx import _LANG_CONFIG as _CCX_LANG_CONFIG  # noqa: PLC2701 — composition contract
from slop.compose.git import NumstatCommitRecord, git_log_numstat
from slop.ast.treesitter import detect_language
