...
beneath the per-substrate rule wrappers under ``slop.structure.rules``,
``slop.lexicon.rules``, and ``slop.linter.rules``, and beneath the
metric kernels in ``slop._structural``.
"""
