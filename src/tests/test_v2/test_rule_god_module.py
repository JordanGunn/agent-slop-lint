...
Exercises ``run_god_module_v2`` end-to-end via the Structure view.
...
from slop.structure.rules.god_module import run_god_module_v2
...
class TestGodModuleV2:
    def test_below_threshold_passes(self, tmp_path: Path):
        ...
        result = run_god_module_v2(_structure(tmp_path), _rc(20), _sc(tmp_path))
